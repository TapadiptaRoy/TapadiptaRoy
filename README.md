...
Full-stack developer building end-to-end applications with React.js, Next.js, Node.js, and Express — with a growing focus on integrating LLMs into production workflows. Currently deepening my AI/ML fundamentals to grow further into applied AI engineering.
...
**Stack:** React, Vite, Tailwind, Node.js, Express, Claude API (Anthropic)
🔗 [Live Demo](https://cv-analyser-ruddy.vercel.app/)

### [Job Tracker](https://github.com/TapadiptaRoy/job-tracker)
Full-stack job application tracker with JWT-based auth, a smart analytics engine (response rates, follow-up alerts, weekly stats), and a Kanban-style pipeline view.
...
⭐️ From [TapadiptaRoy](https://github.com/TapadiptaRoy)
